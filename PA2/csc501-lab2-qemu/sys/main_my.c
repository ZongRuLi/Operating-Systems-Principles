...
void test8 ()
{
        ...
        rd1 = create(reader8, 2000, 20, "reader8A", 3, 'A', lck, 30);
        wr1 = create(writer8, 2000, 20, "writer8B", 3, 'B', lck, 30);
        wr2 = create(reader8, 2000, 20, "reader8C", 3, 'C', lck, 25);
...
void test8_2 ()
{
        ...
        rd1 = create(reader8, 2000, 19, "reader8A", 3, 'A', lck, 30);
        wr1 = create(writer8, 2000, 19, "writer8B", 3, 'B', lck, 30);
        wr2 = create(reader8, 2000, 19, "reader8C", 3, 'C', lck, 25);
